...
class TeenagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teenager" do
    assert_difference('Teenager.count') do
      post teenagers_url, params: { teenager: { address: @teenager.address, email: @teenager.email, id: @teenager.id, id_facebook: @teenager.id_facebook, identification: @teenager.identification, location: @teenager.location, name: @teenager.name, psychologist_id: @teenager.psychologist_id, teenager_history_id: @teenager.teenager_history_id, telephone: @teenager.telephone } }
    end
  ...
  test "should update teenager" do
    patch teenager_url(@teenager), params: { teenager: { address: @teenager.address, email: @teenager.email, id: @teenager.id, id_facebook: @teenager.id_facebook, identification: @teenager.identification, location: @teenager.location, name: @teenager.name, psychologist_id: @teenager.psychologist_id, teenager_history_id: @teenager.teenager_history_id, telephone: @teenager.telephone } }
